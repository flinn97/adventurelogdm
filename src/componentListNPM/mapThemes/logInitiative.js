class LogInitiative {
    getMapTheme(){
        ...
        containerStyle: { 
          ...
          sectionStyle:{
            default:  {display:'flex', flexDirection:"row", marginBottom:"0vh",alignItems:"center" },
            row:  {display:'flex', flexDirection:"row"},
          ...
          cellStyle:{
            default: {display:"flex",alignContent:"center", verticalAlign:"center",}
          },
...
export default new LogInitiative();
