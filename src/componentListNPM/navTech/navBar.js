...
import Adventure from '../navThemes/adventureLogNav.js'
...
export default class NavBar extends Component {
  ...
  render(){
    ...
    let phoneUI = {
      ...
      adventureLog: <Adventure app={app} alignment={this.props.options?.phoneUIAlignment? this.props.options?.phoneUIAlignment: this.props.alignment} phoneUITheme={this.props.options?.phoneUITheme?this.props.options?.phoneUITheme: this.props.template }theme={this.props.theme? this.props.theme: "adventureLogNav"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
    ...
    let IpadUI = {
      ...
      adventureLog: <Adventure app={app} alignment={this.props.options?.ipadUIAlignment? this.props.options?.ipadUIAlignment: this.props.alignment} phoneUITheme={this.props.options.ipadUITheme?this.props.options.ipadUITheme: this.props.template }theme={this.props.theme? this.props.theme: "adventureLogNav"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
    ...
    let template = {
      ...
      adventureLog:  window.innerWidth<state.phoneUIChange? this.props.options.phoneUI? phoneUI[this.props.options.phoneUI]: phoneUI.legatoDark : window.innerWidth<state.ipadUIChange? this.props.options.IpadUI? IpadUI[this.props.options.IpadUI]: IpadUI.minimal :<Adventure app={app} alignment={this.props.alignment} theme={this.props.theme? this.props.theme: "adventureLogNav"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
