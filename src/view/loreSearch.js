                ...
                {/* <IndexLoreHeirarchy/> */}
                        ...
                        <div  style={{display:"flex", flexDirection:"column", justifyContent:"center", justifyItems:"center", marginBottom:"70px",}}>
                              ...
                              width:"fit-content", alignSelf:"flex-end",}}>
                                      ...
                                      fontSize: '16px', }}
                                    />
                                     <div style={{display:"flex", flexDirection:"column", justifyContent:"center", justifyContent:"flex-end",
                                     width:"100px",alignItems:"center",marginLeft:"8px", marginBottom:"-22px", marginRight:"8px"}}
                                                  >
                                                          <div style={{width:"100px", fontSize:styles.fonts.fontSmallest, justifyContent:"center", textAlign:"center", 
                                                  ...
                                                  loreList
                                                    ...
                                                    style={{ width:"fit-content", height:"fit-content",transition:!this.state.isGrabbing?'transform 1.2s cubic-bezier(0.22, 1, 0.36, 1)':"",}}>
                                                            {!this.state.isGrabbing &&
                                                              <div className='hand' title={"You can drag and drop this lore into other lore items"} style={{color:"white", width:"fit-content", zIndex:"20", padding:"2px",
