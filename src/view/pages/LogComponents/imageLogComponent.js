...
export default class ImageLogComponent extends Component {
  ...
  render() {
    ...
    return (
      <div className="hover-img" title={"The GM sent this. " + srcT} style={{
        justifyContent: "center", maxHeight: phone?window.innerWidth:"650px",
        display: "flex", flexDirection: "center", padding: phone ? "0px" : "12px", width: "100%", cursor: "pointer",
        flexDirection: "column", paddingTop: phone ?"12px":"",
      }}>
        <img
          onClick={() => {
            if (!phone) {
              ...
              window.open(src, '_blank'); // Open in a new tab
            }

          }}

          draggable="false" alt={``} src={src} style={{
            objectFit: "cover",
