   ...
   />;
    ...
    return (
      <div style={{ 
        ...
        <div style={{color:styles.colors.color4, fontSize:phone?styles.fonts.fontSmall:styles.fonts.fontSmallest, marginTop:phone?"15px":"18px", marginBottom:phone?"2px":"8px"}}>
          Initiative Order
        </div>
