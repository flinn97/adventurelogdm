...
class MainContent extends Component{
  ...
  render(){
    ...
    fontSize:styles.fonts.fontHeader4,  color:styles.colors.colorWhite}}>
      ...
      <div style={{color:"white"}} onClick={()=>{dispatch({popupSwitch:"partnerPopup", operation:"cleanJsonPrepare", operate: "addpartnerRequest", object:{type:"partnerRequest", userId:state.user.getJson()._id}})}}>Become a Partner</div>
    </div>
    )
  }
}
