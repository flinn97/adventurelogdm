  ...
  render() {
    ...
    return (
      ...
      background: "linear-gradient(to right, "+styles.colors.color1+"82, "+styles.colors.color2+" )", borderRadius:"11px"
          ...
          <Link style={linkStyle} to="../admin/requests">Requests</Link>
          <Link style={{...linkStyle, backgroundColor:styles.colors.color8+"78", color:"white"}} to="../admin/submissions">Submissions</Link>
        </div>
